...
import { i as BUNDLED_PROVIDER_PLUGIN_ID_ALIASES, n as BUNDLED_LEGACY_PLUGIN_ID_ALIASES } from "./bundled-capability-metadata-CRaf2CgC.js";
import { n as defaultSlotIdForKey, r as hasKind } from "./slots-MuZQUpF7.js";
...
function resolveEffectiveEnableState(params) {
	...
	if (params.origin === "bundled" && !base.enabled && (base.reason === "bundled (disabled by default)" || base.reason === "not in allowlist") && isBundledChannelEnabledByChannelConfig(params.rootConfig, params.id)) return { enabled: true };
	return base;
}
...
//#endregion
export { normalizePluginsConfig as a, resolveMemorySlotDecision as c, normalizePluginId as i, hasExplicitPluginConfig as n, resolveEffectiveEnableState as o, isTestDefaultMemorySlotDisabled as r, resolveEnableState as s, applyTestPluginDefaults as t };
