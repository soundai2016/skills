...
import { o as stripChannelTargetPrefix, r as createChatChannelPlugin, s as stripTargetKindPrefix, t as buildChannelOutboundSessionRoute } from "./core-dD_26-eH.js";
...
import { r as createResolvedApproverActionAuthAdapter, t as resolveApprovalApprovers } from "./approval-runtime-CRE54ofV.js";
...
import { d as requiresExplicitMatrixDefaultAccount } from "./storage-paths-CX5IX_Oe.js";
import { a as resolveMatrixAccountConfig, i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-CLFd3tNY.js";
import "./runtime-api-P1MvKgm7.js";
import { n as normalizeMatrixAllowList, r as normalizeMatrixUserId, t as resolveMatrixRoomConfig } from "./rooms-1-v03HE7.js";
...
import { f as setMatrixThreadBindingMaxAgeBySessionKey, u as setMatrixThreadBindingIdleTimeoutBySessionKey } from "./thread-bindings-shared-Bb-_5lUR.js";
...
const matrixMessageActions = {
	...
	handleAction: async (ctx) => {
		const { handleMatrixAction } = await import("./tool-actions.runtime-BGqOTtM-.js");
...
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-BJXwCAwq.js"), "matrixChannelRuntime");
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-awD8wE7K.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
