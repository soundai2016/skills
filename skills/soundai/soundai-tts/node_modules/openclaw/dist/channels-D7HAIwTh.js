...
import { r as listChannelPluginCatalogEntries } from "./catalog-CP72_OZA.js";
import { t as createClackPrompter } from "./clack-prompter-CAHiS_6D.js";
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-DKG0bgwA.js";
import { n as buildReadOnlySourceChannelAccountSnapshot, t as buildChannelAccountSnapshot } from "./status-DzSiHznP.js";
import { t as parseLogLine } from "./parse-log-line-_U_NeV0u.js";
import { a as describeBinding, n as requireValidConfigSnapshot, r as applyAgentBindings, t as requireValidConfigFileSnapshot } from "./config-validation-DJrmmEGX.js";
import { a as isCatalogChannelInstalled, n as runCollectedChannelOnboardingPostWriteHooks, t as createChannelOnboardingPostWriteHookCollector } from "./onboard-channels-Dk2LQha7.js";
...
async function channelsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, { setupChannels }] = await Promise.all([import("./agents.config-P63g1-NV.js"), import("./onboard-channels-BCN8GM5Q.js")]);
	...
	const loadScopedPlugin = async (channelId, pluginId) => {
		...
		const { loadChannelSetupPluginRegistrySnapshotForChannel } = await import("./plugin-install-CE5mZe3R.js");
	...
	if (!channel && catalogEntry) {
		...
		if (!isCatalogChannelInstalled({
			...
			const { ensureChannelSetupPluginInstalled } = await import("./plugin-install-CE5mZe3R.js");
			const prompter = createClackPrompter();
