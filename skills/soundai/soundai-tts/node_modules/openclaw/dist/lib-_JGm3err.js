...
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-ZdGntsPT.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-D7aj6Cq6.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-DIVaT3TM.js";
import { l as toRatio, n as decodeString } from "./Util-4avUI0vI.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-DUOi5QAl.js";
import { t as APEv2Parser } from "./APEv2Parser-B6_OQZrD.js";
import { r as hasID3v1Header } from "./ID3v1Parser-BGPC_GJ5.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-C0Voh3wt.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-B6cXGiCj.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-DdkuLQU5.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-CP3jeWni.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-DegMJ4cr.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-D-tZv-hc.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-zXgzZ3QF.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-BfkhXrKu.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-CSF_91mp.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-DbFfNFK7.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-JMEnD5wI.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-Ddb4g8eW.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-CJcUDp5-.js")).WaveParser;
	}
};
//#endregion
