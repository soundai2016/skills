...
import { f as resolveControlUiLinks, g as waitForGatewayReachable, i as formatControlUiSshHint, u as probeGatewayReachable } from "./onboard-helpers-D5AZU-7N.js";
...
import { t as runTui } from "./tui-Da-djW_y.js";
...
async function finalizeSetupWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-DvvRa7il.js");
	...
	if (webSearchProvider) {
		const { resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-DUIWGxT5.js");
		...
		const { hasExistingKey, hasKeyInEnv } = await import("./onboard-search-DUIWGxT5.js");
