...
if (!isMainModule({
	...
	const { installGaxiosFetchCompat } = await import("./gaxios-fetch-compat-BCQFEdAR.js");
...
function tryHandleRootHelpFastPath(argv, deps = {}) {
	...
	import("./root-help-8fmbY5Nl.js").then(({ outputRootHelp }) => {
...
function runMainOrRootHelp(argv) {
	...
	import("./run-main-Bu-vpfI5.js").then(({ runCli }) => runCli(argv)).catch((error) => {
