...
async function loadMSTeamsSdk() {
	const [appsModule, apiModule] = await Promise.all([import("./dist-B-Q5roFB.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-CFfAwbwv.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]);
	return {
		App: appsModule.App,
...
async function createNoOpHttpPlugin() {
	await import("./Reflect-Bxyflbq_.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
	const { PLUGIN_METADATA_KEY } = await import("./plugin-U9F6yWBT.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
	const { PLUGIN_DEPENDENCIES_METADATA_KEY } = await import("./dependency-C08UEP0J.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
	const { PLUGIN_EVENTS_METADATA_KEY } = await import("./event-Ci2irGo1.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
...
async function createBotFrameworkJwtValidator(creds) {
	const { JwtValidator } = await import("./jwt-validator-BxgunFgh.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
