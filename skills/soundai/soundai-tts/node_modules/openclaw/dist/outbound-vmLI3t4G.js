...
async function pcmToSilk(pcmBuffer, sampleRate) {
	const result = await encode(new Uint8Array(pcmBuffer.buffer, pcmBuffer.byteOffset, pcmBuffer.byteLength), sampleRate);
	return {
...
async function audioFileToSilkBase64(filePath, directUploadFormats) {
	...
	if ([".slk", ".slac"].includes(ext)) {
		...
		if (isSilk(new Uint8Array(stripped.buffer, stripped.byteOffset, stripped.byteLength))) {
...
//#endregion
export { getHomeDir as $, PLUGIN_USER_AGENT as A, sendC2CVideoMessage as B, audioFileToSilkBase64 as C, isVoiceAttachment as D, isGlobalTTSAvailable as E, onMessageSent as F, sendGroupImageMessage as G, sendChannelMessage as H, sendC2CFileMessage as I, sendGroupVoiceMessage as J, sendGroupMessage as K, sendC2CImageMessage as L, getAccessToken as M, getGatewayUrl as N, resolveTTSConfig as O, initApiConfig as P, stopBackgroundTokenRefresh as Q, sendC2CInputNotify as R, readFileAsync as S, formatDuration as T, sendDmMessage as U, sendC2CVoiceMessage as V, sendGroupFileMessage as W, sendProactiveGroupMessage as X, sendProactiveC2CMessage as Y, startBackgroundTokenRefresh as Z, normalizeMediaTags as _, sendCronMessage as a, resolveQQBotLocalMediaPath as at, fileExistsAsync as b, sendPhoto as c, debugError as ct, sendVideoMsg as d, getQQBotDataDir as et, sendVoice as f, parseQQBotPayload as g, isMediaPayload as h, recordMessageReply as i, normalizePath as it, clearTokenCache as j, textToSilk as k, sendProactiveMessage as l, debugLog as lt, isCronReminderPayload as m, getMessageReplyConfig as n, isLocalPath as nt, sendDocument as o, runDiagnostics as ot, encodePayloadForCron as p, sendGroupVideoMessage as q, getMessageReplyStats as r, isWindows as rt, sendMedia as s, sanitizeFileName as st, checkMessageReplyLimit as t, getQQBotMediaDir as tt, sendText as u, checkFileSize as v, convertSilkToWav as w, formatFileSize as x, downloadFile as y, sendC2CMessage as z };
