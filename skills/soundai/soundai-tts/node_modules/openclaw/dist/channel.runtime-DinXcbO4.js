...
import "./accounts-CzEDe9Dv.js";
import "./runtime-api-CFu9mlsz.js";
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-SY4UMVuz.js";
import { t as sendMessageZalo } from "./send-Cd2ly4hc.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-BSWbmpxe.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-Cff3hku4.js");
